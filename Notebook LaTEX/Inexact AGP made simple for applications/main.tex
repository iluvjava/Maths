...
\section{Linear convergence for the proximal problem in the inner loop}
    ...
    \subsection{Concrete examples where we can have linear convergence}
        ...
        \begin{definition}[quasi-strongly convex function]
            
        \end{definition}
        \begin{definition}[quadratic growth]
            
        \end{definition}
        \begin{fact}[error bound quadratic growth equivalence]
            
        \end{fact}
        \begin{fact}[Hoffman error bound]
            
        \end{fact}
        \begin{fact}[A characterization of quasi strongly convex function]
