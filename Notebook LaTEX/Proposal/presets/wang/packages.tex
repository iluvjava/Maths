...
\usepackage[colorinlistoftodos,textsize=footnotesize, color=yellow]{todonotes} % https://tug.ctan.org/macros/latex/contrib/todonotes/todonotes.pdf
% \usepackage[disable]{todonotes} % NULLIFY TODO NOTES. 
\usepackage{soul} 
