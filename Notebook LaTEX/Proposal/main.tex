...
\section{Catalyst accelerations and future works}\label{sec:catalyst}
    ...
    \subsection{Introduction to Catalyst}
        ...
        \todoinline{Add more details about what they actually did in the original paper. }
        \par
        He also provided rigorous convergence claim under various scenarios of inner loop termination strategies. 
        \par 
        ...
        The paper is phenomenal at addressing the following: 
        \begin{enumerate}
            \item Getting the error sequence $(\epsilon_k)_{k \ge 0}$ to asserts fast convergence of the outer loop. 
            \item Two termination criteria for the inner loop given the desired accuracy which expedite the convergence and makes simpler proofs for the convergence of the overall algorithm. 
        \end{enumerate}
