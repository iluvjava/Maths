...
\section{Introduction}
    ...
    \todo{$\blacksquare$ Add Lin's papers and Paquette's papers.  }{\hl{It's based on a series of papers}} in the topic of Catalyst Meta Acceleration method for First Order Variance Reduced Methods. 
...
\section{Preliminaries}
    ...
    \subsection{Fundamentals in non-convex analysis}
        ...
        \begin{remark}
            ...
            \todo{$\blacksquare$ Add bib \\ $\square$ Cite. }\hl{Pang, Cui's book}
        \end{remark}
    ...
    \subsection{Nesterov's estimating sequence technique}
        ...
        \todo{$\blacksquare$ Add Guler's 1992 new proximal point paper. \\ $\square$ Cite it. }
        {\hl{Güler}} 
        ...
        \todo{$\blacksquare$ Add the paper: ``Accelerating the cubic regularization of Newton’s method on convex
        problems''\\ $\square$ Cite it.}
        {\hl{Nesterov}}
        also used the technique to design an accelerated cubic regularized Newton's method. 
        In 
        \todo{$\blacksquare$ Cite it. }\hl{(6.1.19) of Nesterov's book }\cite{nesterov_lectures_2018}, it's also used to derive a method of accelerated mirror descent. 
        And finally, 
        \todo{$\blacksquare$ Add paper: ``Accelerated regularized newton methods for minimizing composite convex functions'' \\ $\square$ Cite it. }
        {\hl{Geovani N. et al}}
...
\section{Unifying NAG, and weakening the sequence assumption for convergences}\label{sec:unify-nes-acceleration}
    ...
    \todo{$\blacksquare$ Add Nesterov's original paper. \\ $\square$ Cite it.  }
    {\hl{Proposed back in 1983 the original Nesterov's acceleration method}} 
    ...
    \todo{$\blacksquare$ Add Nesterov's new book. \\ $\blacksquare$ Cite it.}
    ...
    \todo{$\blacksquare$ Add Beck 2009 FISTA original paper. $\square$ Cite it.}
    {\hl{Beck and Toubelle}} 
    ...
    \todo{
        ...
        \\ 
        $\square$ Cite Section 5.2.2 for the former, cite the entirety for the later. 
    }
    {\hl{See} (5.2.2) Necoara et al. and Aujol et al. } 
    ...
    \todo{
        $\blacksquare$ Add Neol J. Walkington's ``Nesterov's Method for Convex  Optimization''. \\ $\square$ Cite it. 
    }
    ...
    \todo{
        ...
        \\ $\square$ Cite it. }
    {\hl{
        The same variant also appears in Beck's book as V-FISTA, and Nesterov's book as (2.2.22).
    }} 
    \par
    ...
    \subsection{Our Contributions, organizations}
        ...
        \todo{
            $\blacksquare$ Add ``On the convergence of the iterates of...'' \\ $\square$ Cite them.}
        {\hl{Chambolle, Dossal}}, 
        ...
        \todo{
            $\blacksquare$ Add beck's original FISTA Paper. \\$\square$ Cite it.
        }
        {\hl{Beck}}. 
        ...
        \todo{$\square$ Cite the Chambolle, Dossal 2015 paper here again. }
        {\hl{Chambolle Dossal}}. 
    ...
    \subsection{Equivalent forms of R-WAPG algorithm}\label{ssec:quiv-repr-rwapg}
        ...
        \begin{remark}
            ...
            \todo{$\blacksquare$ Add them \\ $\square$ Cite them. }
        ...
        \begin{remark}
            ...
            \todo{$\square$ Cite Chambolle Dossal 2015 again. }
