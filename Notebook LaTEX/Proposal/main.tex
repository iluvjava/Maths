...
\section{Preliminaries}
    ...
    \subsection{Fundamentals in convex analysis}
        \todoinline{
            Definitions: 
            \begin{enumerate}
                \item The proximal gradient operator. 
                \item The proximal mapping operator. 
                \item The Bregman Divergence of function. 
                \item Strong convexity. 
            \end{enumerate}
            Lemma: 
            \begin{enumerate}
                \item Quadratic growth conditions of a strongly convex function. 
            \end{enumerate}
            Theorems: 
            \begin{enumerate}
                \item The proximal gradient inequality, for additive composite objective where the smooth part is $\mu \ge 0$ strongly convex. 
            \end{enumerate}
        }
