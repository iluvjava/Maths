...
\section{Catalyst accelerations and future works}\label{sec:catalyst}
    ...
    \subsection{Potential future research}\label{ssec:catalyst-future}
        ...
        \subsubsection{Our ideas on future works of Catalyst Acceleration}
            ...
            \par
            From a complexity theoretical point of view, Catalyst acceleration didn't attempt at narrowing the lower complexity bound functions that are convex and nonsmooth and lack of any exact proximal oracle. 
            It is absolutely possible that, for any black box nonsmooth optimization problem, the same lower bound convergence rate $\mathcal O\left(1/\sqrt{k}\right)$ as stated in Theorem 3.2.1 in Nesterov's book \cite{nesterov_lectures_2018}. 
            Unfortunately it is absolutely nontrivial to see that is true because $\mathbb A$ optimizes Moreau Envelope $\mathcal M^*_{\kappa^{-1}F}(x)$ through inexact evaluation and the Moreau Envelope has Lipschitz gradient, for $\mathbb A$ Theorem 3.2.1 doesn't apply. 
