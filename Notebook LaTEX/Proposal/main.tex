...
\section{Catalyst accelerations and future works}\label{sec:catalyst}
    ...
    \subsection{Introduction to Catalyst}
        ...
        {\hl{incremental methods}} \cite{bertsekas_incremental_2011,bertsekas_incremental_2017}
        ...
        \todoinline{\noindent
            ...
            \begin{enumerate}
                \item[$\blacksquare$] SVRG: Proximal stochastic gradient with progressive variance reduction. 
                \item[$\blacksquare$] Finito: A faster, permutable incremental gradient method for big data problems
                \item[$\blacksquare$] SAG: Minimizing finite sums with the stochastic average gradient
                \item[$\blacksquare$] SAGA: A fast incremental gradient method with support for non-strongly convex composite objectives. 
            \end{enumerate}
        }
        \par
    ...
    \subsection{The second Catalyst Acceleration paper}
        ...
        \subsubsection{Consequences of the inner loop termination criteria}
            ...
            \par
            Finally, besides Definition \ref{def:catalyst-termination-c1}, \ref{def:catalyst-termination-c2}, there is the ``Fixed Budget" termination criterion. 
            It terminates $\mathbb M$ after a fixed number of iteration. 
            ...
            This innocent detail helps to develop a nonconvex variant of Catalyst call 4WD Catalyst which is the focus of the paper by Paguette \cite{paquette_catalyst_2018}. 
