...
\section{Introduction}
    ...
    \todo{Add citations here. }{It's based on a series of papers} in the topic of Catalyst Meta Acceleration method for First Order Variance Reduced Methods. 
...
\section{Preliminaries}
    \todoinline{
        Assumptions: Additive composite type convex objective until specified.  
    }
    \subsection{Fundamentals in convex analysis}
        \todoinline{
            Definitions: 
            \begin{enumerate}
                \item [$\square$]Strong convexity of a function. 
                \item [$\square$]The proximal gradient operator. 
                \item [$\square$]The proximal mapping operator. 
                \item [$\square$]The Bregman Divergence of function. 
            \end{enumerate}
            Lemmas: 
            \begin{enumerate}
                \item [$\square$]Quadratic growth conditions of a strongly convex function. 
                \item [$\square$]The proximal gradient envelope.
                \item [$\square$]A property of gradient mapping. 
            \end{enumerate}
            Theorems: 
            \begin{enumerate}
                \item [$\square$]The proximal gradient inequality, for additive composite objective where the smooth part is $\mu \ge 0$ strongly convex. 
            \end{enumerate}
        }
...
\section{Unifying variants of Nesterov's accelerated methods}\label{sec:unify-nes-acceleration}
    \todoinline{
        This section is really about stating the results of the draft paper and no explaining will be done here. 
        Along with the content of the draft paper, we will also explain the origin and inspirations of the ideas. 
    }
    \todoinline{
        Definitions:
        \begin{enumerate}
            \item Method of Nesterov's estimating sequence.
