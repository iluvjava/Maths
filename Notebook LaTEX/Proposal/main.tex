...
\section{Catalyst accelerations and future works}\label{sec:catalyst}
    ...
    \subsection{Introduction to Catalyst}
        ...
        \todoinline{\noindent
            ...
            \begin{enumerate}
                \item SVRG: Proximal stochastic gradient with progressive variance reduction. 
                \item Finito: A faster, permutable incremental gradient method for big data problems
                \item SAG: Minimizing finite sums with the stochastic average gradient
                \item SAGA: A fast increment al gradient method with support for non-strongly convex composite objectives. 
            \end{enumerate}
        }
        \par
