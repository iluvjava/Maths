...
\section{The method of Free R-WAPG}\label{sec:free-rwapg}
    ...
    \subsection{Future works for R-WAPG}
        ...
        \subsubsection{Nesterov's idea of strong convexity transfer}
            \todoinline{\noindent
                In terms of theories, it's possible to consider: 
                \begin{enumerate}
                    \item Nesterov, 2013, ``Gradient methods for minimizing composite functions'', strong convexity transfer. 
                    \item ``An introduction to continuous optimization for imaging'', Algorithm 5, the same thing is there as well. 
                \end{enumerate}
                In Nesterov's, take note of Algorithm: Accelerated Method (4.9) and the convergence claim: Theorem 6. 
            }
            We consider the case that $F = f + g$ where, $f$ is $L$ Lipschitz smooth, $\mu_f \ge 0$ strongly convex and $g$ is closed convex. 
            In Nesterov's 2013 paper \cite{nesterov_gradient_2013}, he consider accelerated  minimization problem $\phi = f + \Psi$ with $f$ $L_f$ smooth and $\Psi$ being $\mu_\Psi \ge 0$ strongly convex. 
            \par
            ...
            It's not trivial on how the R-WAPG framework can be modified to include strong convexity presenting in the nonsmooth part. 
...
\section{Catalyst accelerations and future works}\label{sec:catalyst}
    ...
    \subsection{Potential future research}\label{ssec:catalyst-future}
        ...
        \subsubsection{Our ideas on future works of Catalyst Acceleration}
            One intriguingly detail in the Catalyst framework eluded us. 
            ...
            Schimdt et al. \cite{schmidt_minimizing_2017} also requires Lipscthiz smoothness for the non-smooth part of a composite objective. 
            Xiao, Zhang, SVRG \cite{xiao_proximal_2014} requires Lipscthiz gradient assumption as well. 
