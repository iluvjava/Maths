...
\begin{abstract} 
    ...
    Additionally, we proposed a line search method to dynamically adjust the strong convexity index $\mu$ and Lipschitz constant of the gradient in algorithm implementations based on the PPM understanding, presented numerical experiments. 
