...
\section{Introduction}
    ...
    For a variant of accelerated gradient where the iterates converge, see Chambolle and Dossal \cite{chambolle_convergence_2015}. 
...
\section{Recovering existing variants of Nesterov accelerated gradient}\label{sec:recovery}
    ...
    \subsection{Recovering FISTA} 
        ...
        \begin{lemma}[Similar triangle form]
            \quad \\
