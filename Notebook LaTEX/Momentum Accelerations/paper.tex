...
\section{Introduction}
    ...
    Ahn and Sra explored the interpretation of Nesterov acceleration as the proximal point method applied to an upper surrogate function, and then a lower surrogate function. 
    ...
    \par
    Classical analysis and extension of Nesterov accelerated gradient exist in the literatures. 
