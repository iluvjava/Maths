...
\section{Introduction}
    ...
    \subsection{Background}
        ...
        See Goldstein \cite{goldstein_field_2016} and references therein for different types of heuristics for restarting. 
        ...
        See Aujol \cite{aujol_parameter-free_2023}, Calatroni and Chambolle \cite{calatroni_backtracking_2019} and references within for algorithms that has optimal convergence rate for $L$ smooth and $\mu \ge 0$ strongly convex function, without needing the values of $\mu, L$ run the algorithm. 
        ...
        See Moursi et al. \cite{moursi_accelerated_2023} for a proof of a specific type of parameter free restarting heuristics without function values for one dimensional functions and its extension. 
