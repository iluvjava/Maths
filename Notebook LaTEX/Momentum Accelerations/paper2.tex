...
\section{Numerical experiments}\label{sec:numerical-experiments}
    ...
    \begin{algorithm}
        \caption{Inexact V-FISTA}\label{alg:routine1}
        \begin{algorithmic}[1]
            \Procedure{Inexact V-FISTA}{$h=f+g, x_0, y_0$}
        ...
        \end{algorithmic}
    \end{algorithm}
    \subsection{Results from numerical experiments}
    \subsection{Cannonical form of convex quadratic}
    \subsection{Convergence analysis by eigensystem of the generalized matrix recurrences of Nesterov's acceleration}
