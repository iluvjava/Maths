...
\section{Preliminaries}\label{sec:preliminaries}
    ...
    \hyperref[lemma:grad_map_linearization]{Lemma \ref*{lemma:grad_map_linearization}}
    differs from the original analysis presented in \cite{ahn_understanding_2022} because it compatifies the the smoothness together with proximal inequality into one statement which eventually simplifies the convergence proof of the generic PPM formulation of accelerated gradient in
