...
\section{Numerical experiments}\label{sec:numerical-experiments}
    ...
    \end{example}
    In this section, we will present numerical results and exploratory theoretical results concerning \hyperref[alg:inexact-vfista]{Algorithm \Ref*{alg:inexact-vfista}}. 
