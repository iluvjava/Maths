...
\section{Different forms of Nesterov's accelerated gradient}
    ...
    \subsection{The definitions for generic forms}
        ...
        \begin{definition}[S-CVX Generic Similar Triangle]\label{def:S-CVX-generic-similar-triangle}
            Let $h = f + g, \mathcal G_L, \mathcal T_L, L$ be given by 
            \hyperref[ass:smooth-non-smooth-lip-scvx]
            {Assumption \ref*{ass:smooth-non-smooth-lip-scvx}}
    ...
    \subsection{The relations between these forms}
        ...
        \hyperref[def:S-CVX-generic-similar-triangle]
        { Definition \ref*{def:S-CVX-generic-similar-triangle}} 
        (S-CVX Similar Triangle Form), it is an instance of
        \hyperref[def:S-CVX-PPM-APG]
        {Definition \ref*{def:S-CVX-PPM-APG}}
        ...
        Shows that S-CVX Similar Triangle Form is an instance of S-CVX PPM APG where the step sizes sequence $\tilde \eta_t, \eta_t$ satisfies equality: 
        $$
        ...
        is an instance of S-CVX Similar Triangle form if and only if when $\mu = 0$. 
...
\section{Lypunov analysis of the algorithm}
    ...
    \begin{proof}
        ...
        \\
        Consider $(\sigma_k - \epsilon_k)(\text{Equation }(\ref*{eqn:st2p-2})) + \epsilon_k(\text{Equation }(\ref*{eqn:st2p-1})) \le 0$ for any $k \in \N$, it simplifies to (it's proved later):
        {\small
        \begin{align}
            (\sigma_k - \epsilon_k)(\Delta_k - \Delta_{k - 1}) + \epsilon_k \Delta_k 
            + 
        ...
        Let the base case be: $\Phi_0 = (1/2)\Vert x_0 - x^+\Vert^2$. 
