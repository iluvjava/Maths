...
\section{Different forms of Nesterov's accelerated gradient}
    ...
    \subsection{The relations between these forms}
        ...
        {Definition \ref*{def:S-CVX-generic-similar-triangle}}(S-CVX Similar Triangle Form), 
        ...
        is a special case of S-CVX Similar Triangle form if and only if when $\mu = 0$. 
