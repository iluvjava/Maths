...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Varieties of Nesterov accelerated gradient}\label{sec:AG_varieties}
        ...
        \subsubsection{AG Concrete Examples}
            In this section we state some variants of the Nesterov accelerated gradient method found in the literatures. 
        ...
        \label{sec:AG_useful_information}
            ...
            \begin{lemma}[Similar Triangule Form I via Generic Tri Points]
                \quad \\
    ...
    \subsection{Generic Lyapunov analysis for Accelerated gradient via PPM}
        ...
        \begin{proof}
            ...
            has $x_{t + 1} = \prox{\phi_t}(x_t)$ and therefore we can use the Lyapunov inequality for PPM (\hyperref[thm:ppm_descent_ineq]
    ...
    \subsection{Scenario II}
        ...
        % Recall similar a lemma about similar triangle form here. 
