...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Varieties of Nesterov accelerated gradient}
        ...
        \begin{definition}[AG Generic PPM Form]\label{def:agg_ppm}
        ...
        \begin{definition}[AG Generic PPM Form with Strong Convexity]\label{def:agg_ppm_scvx}
        ...
        \begin{proposition}[Triangular Form via PPM Form]\label{prop:tri_form_via_ppm}
    ...
    \subsection{Scenario II}
        ...
        We will discuss how other choices of $\tilde \eta_{t +1}$ results in other varients of the Accelerated gradient such as the variants proposed by Chambolle \cite{chambolle_convergence_2015}. 
        \par\noindent
        ...
        \begin{remark}
            ...
            \begin{enumerate}
                ...
                \item 
                The updates for $z_{t + 1}, x_{t + 1}$ are based on $y_t, x_t$, therefore vector $z_{t + 1} - y_t$ parallels to $x_{t + 1} - x_t$. 
        ...
        \end{proof}
        \begin{remark}
            This variant is distinct from the variants proposed by Chambolled \cite{chambolle_convergence_2015}, but both of which fits into the same frameworks. 
            At the time of writing, the writer is still investigating the relations between these variants of algorithms.. 
        \end{remark}
