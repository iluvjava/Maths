...
\section{The proximal point method with convexity}
    ...
    \subsection{The Lyapunov function of convex PPM}
        ...
        \begin{remark}
            ...
            The answer is not realized by me, nor is it in Rockafellar or Guler's writings. 
...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Varieties of Nesterov accelerated gradient}
        ...
        \begin{definition}[Accelearted Gradient Generic Original Form]\label{def:agg_original}
        ...
        \begin{definition}[Accelerated Gradient Generic Triangular Form]\label{def:agg_tri}
            
        \end{definition}

        \begin{definition}[Accelerated Gradient Generic PPM Form]\label{agg_ppm}
