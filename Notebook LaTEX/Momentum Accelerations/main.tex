...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Varieties of Nesterov accelerated gradient}
        \subsubsection{AG Abstract Forms}
            ...
            \end{definition}
            \begin{remark}
                This formulation of the Nesterov Accelerated gradient method is a second handed idea taken from Ahn \cite{ahn_understanding_2022}. 
                It is claimed that this is an PPM formulation of a class of accelerated gradient method. 
            \end{remark}
            ...
            \end{proof}
        \subsubsection*{Specific Instances of Accelerated Gradient Method}
