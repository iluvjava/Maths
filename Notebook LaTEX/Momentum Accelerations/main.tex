...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Varieties of Nesterov accelerated gradient}
        ...
        \begin{definition}[Accelearted Gradient Generic Original Form]
        ...
        \begin{definition}[Accelerated Gradient Generic Triangular Form]
            
        \end{definition}

        \begin{definition}[Accelerated Gradient Generic PPM Form]
