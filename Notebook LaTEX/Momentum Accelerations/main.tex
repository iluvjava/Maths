...
\section{Accelerated gradient descent and PPM}
    ...
    \subsection{Scenario I}
        ...
        \end{proof}
        \begin{remark}
            In the original writing by Ahn \cite[4.9]{ahn_understanding_2022}, they didn't list what exactly this algorithm is. Here we stated that it should be equivalent to the acceleration algorithm stated in Ryu \cite[algorithm 12.1]{ryu_large-scale_2022}. 
        \end{remark}
