...
\section{Accelerated gradient descent and PPM}
    ...
    They used PPM to derive different variations of the Nesterov accelerated gradient algorithms. 
    ...
    Their analysis results are relatively simple and exhibit powerful extensions to several variants of the Nesterov accelerated gradient. 
    \par\noindent
    ...
    One recent development of the accelerated PPM is an algorithmic framework named: ``Universal Catalyst acceleration", proposed by \cite{lin_universal_2015}.
