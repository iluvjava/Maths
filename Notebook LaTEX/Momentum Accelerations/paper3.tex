...
\section{Formulation of WAPG and its convergence rates}

    \begin{definition}[Weak accelerated proximal gradient (WAPG)]\label{def:wapg}
        \;\\
    ...
    \begin{proposition}[WAPG convergence claim]\label{prop:wagp-convergence}
    ...
    \begin{proof}  
        Recall the 
        \hyperref[prop:stepwise-lyapunov]{Proposition \ref*{prop:stepwise-lyapunov}}, 
        since the choice of $\gamma, \hat \gamma$ is arbitrary choices for the theorem, we choose $\gamma = \rho_{k - 1} L \alpha_{k - 1}^2, \hat \gamma = L \alpha_k^2$, giving us: 
        {\footnotesize
        \begin{align*}
...
\section{WAPG covers variants of APG in the literatures}
    ...
    \subsection{Narrowing it down}
        \begin{proposition}[WAPG intermediate Form I]\label{prop:wapg-intermediate-form}
            Suppose that $(y_i, x_i, v_i)$ are generated by 
            \hyperref[def:wapg]{Definition \ref*{def:wapg}}
            for all $0 \le i \le k$. 
        ...
        \begin{proposition}[WAPG fits similar triangle form]\label{prop:wagp-st-form}
            ...
            Let $(x_k, y_k, v_k)$ to be generated as specified by Definition \ref{def:wapg} by the $(\alpha_k)_{k \ge0}$.
            Then the iterate $(v_k)$ can be expressed without $y_k, v_k$: 
            $$
            \begin{aligned}
                y_k &= 
                \left(
    ...
    \begin{proposition}[WAPG fits into Momentum Form]\label{prop:wapg-momentum-form}
