...
\subsection{R-WAPG describes existing accelerations scheme in the literatures}
    ...
    \begin{lemma}[First specialized R-WAPG sequence]\label{lemma:special-rwapg-convergence-claim}
        
    \end{lemma}

    \begin{lemma}[Inverted Chambolle, Dossal 2015 sequence]
        Choose any $a \ge 2$.
        ...
        \end{align*}
        If $\mu = 0$, then $\alpha_k, \rho_k$ satisfies Definition \ref{def:rwapg-seq}. 
