...
\section{Introduction}
    ...
    Let $F$ be $L$-Lipschitz smooth and $\mu \ge 0$ stronlyg convex meaning that there exists $L \in \RR$ such that for all $x \in \RR^n, y\in \RR^n$ it has $\mu\Vert x - y\Vert\le \Vert \nabla F(x) - \nabla F(y)\Vert \le L \Vert x - y \Vert$. 
    ...
    \subsection{Contributions}
        ...
        R-WAPG gives the a convergence claim, and it's consistent with the literatures. 
        \par
...
\section{Equivalent representations of R-WAPG}
    ...
    In brief, the relations of these Propositions and Definitions can be summarized by
    \begin{align*}
...
\section{R-WAPG describes existing accelerations scheme in the literatures}
    ...
    \begin{lemma}[R-WAPG sequences as Inverted FISTA sequence]
    ...
    \begin{lemma}[Chambolle, Dossal 2015 sequences as R-WAPG sequences]\;\\
        ...
        Applying this sequence to Definition \ref{def:r-wapg-momentum-form}, which is the momentum form of R-WAPG, then R-WAPG is reduced to the following scheme: 
        \begin{align*}
        \end{align*}
    \end{lemma}
    \begin{proof}
