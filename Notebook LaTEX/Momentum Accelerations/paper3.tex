...
\section{Preliminaries}
    Throughout, we define $F := f + g$ where $f: \RR^n \rightarrow \RR$ is $L$ Lipschitz smooth and $\mu \ge 0$ strongly convex and $g: \RR^n \rightarrow \overline \RR$ is convex. 
    ...
    \begin{proof}
        ...
        \end{align*}
        The equality is trivially true when $x \in \RR \setminus \dom g$. 
    \end{proof}
    \begin{remark}
