    ...
    \subsection{Numerical experiments}
        ...
        \subsubsection{Simple convex quadratic}
            ...
            \begin{enumerate}
                ...
                \item $0 < \mu < L$, the strong convexity and Lipschitz smoothness constant. 
        ...
        \subsubsection{LASSO}
            ...
            \begin{enumerate}
                ...
                \item $A \in \RR^{M\times N}$ is a matrix of i.i.d random variable, taken from a standard normal distributions. 
                \item $x^+ = [1\; -1\; 1 \; \cdots ]^T \in \RR^N$, it's a vector with alternating $1, -1$ in it. 
                \item Given $x^+$, it has $b = Ax^+ \in \RR^M$. 
                \item Given $A$, estiamtions for $L,\mu$ are given by $L = \Vert A^TA\Vert$, $\mu = \Vert (A^TA)^{-1}\Vert^{-1}$. 
            ...
            The same experiment are repeated 30 times, but each time a different fixed randomized initial condition is picked for all test algorithms. 
            The aggragated statistics of $\delta_k$ are collected for all repetitions, and then grouped by the respective algorithm. 
