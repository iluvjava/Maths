...
\section{Introduction}
    ...
    \subsection{Prior works}
        ...
        \todo{$\square$ Add them \\ $\square$ Cite them.}{\hl{Apidopoulos et al. }}
        ...
        \par 
        See \todo{$\square$ Add them \\ $\square$ Cite them. }{\hl{Attouch H et al.}} for a method inspired by Hessian Damping were used to stabilize the convergence of the Nesterov's momentum without restarting. 
...
\section{Equivalent representations of R-WAPG}
    ...
    \subsection{A list of equivalent representations of R-WAPG}
        ...
        \begin{remark}
            ...
            \todo{$\square$ Add them \\ $\square$ Cite them. }{\hl{in Ryu and Tao's Book}}, 
            right after Theorem 17. 
            We created this form which makes the math that follows simpler. 
            The inspiration of using this as an intermediate representation was inspired by solving Exercise 12.1 in the same Ryu and Tao's Book. 
        \end{remark}
        ...
        \begin{remark}
            ...
            To see a graphical explanations on why such term is used to describe the APG algorithm in the literatures, see 
            \todo{
                $\square$ Add these. $\square$ Cite these. 
            }{\hl{(3.1, 4.1) in Lee et al. and Ahn and Sra}}
            \todoinline{\noindent
                The term ``Method of Similar Triangle'' specific to this particular representation of AGM. 
                For more information, see:  
                \begin{enumerate}
                    \item 3.1, 4.1 in Jongmin Lee et.al's paper ``A geometric structor of Acceleration and its role in mtakng gradients small''
...
\subsection{The method of Free R-WAPG}
    ...
    \subsection{Numerical experiments}
        ...
        \subsubsection{Simple convex quadratic}
            ...
            \begin{align*}
                F(x) = \langle x, A x\rangle. 
            \end{align*}
            The matrix $A$ is set to be positive definite and diagonal. 
