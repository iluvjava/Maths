...
\section{Introduction}
    ...
    \subsection{Contributions}
        ...
        Our results are based the assumption $F = f + g$ where $g:Q \rightarrow \overline\RR$ is convex, and $f$ is an $L$-Lipschitz smooth and $\mu \ge 0$ strongly convex function. 
        \par
...
\section{Preliminaries}
    ...
    Fix any arbitrary $y \in \RR^n$, define the model functions for all $x \in Q$
    \begin{align*}
    ...
    \end{align*}
    When $x \in \RR\setminus Q$, the model function takes $+\infty$ value. 
    ...
    \end{lemma}
    \begin{proof}
        Consider any $x \in Q$, by definition it has: 
        \begin{align*}
            \widetilde{\mathcal M}^{L^{-1}}(x; y) 
            &= 
        ...
        \end{align*}
        The equality is trivially true when $x \in \RR \setminus Q$. 
    \end{proof}
    ...
    \begin{theorem}[Proximal inequality]\label{thm:prox-grad-ineq}
        ...
        \begin{align*}
            ...
            0. 
        \end{align*}
        Recall that $f$ is $\mu \ge 0$ strongly convex and $L$ Lipschitz smooth, hence the following is implied: 
        \begin{align*}
            F(x) - F(T_Ly) - \langle L(y - T_Ly), x - y\rangle
    ...
    \end{theorem}
    \begin{proof}
        For lighter notations in this proof, we use $\mathcal M(\cdot, y), \widetilde{\mathcal M}(\cdot, y)$ instead of $\mathcal M^{L^{-1}}(\cdot, y), \widetilde{\mathcal M}^{L^{-1}}(\cdot, y)$. 
        And we denote $T$ for the proximal gradient operator instead of $T_L$. 
        ...
        % \end{align*}
        % }
        % The first $\implies$ comes from Lemma \ref{lemma:pg-envelope} where we had $- \widetilde{\mathcal M}^{L^{-1}}(x; y) \ge - \mathcal M^{L^{-1}}(x; y)$. 
        % \todoinline{THIS THIS PART IS WRONG WRONG WRONG!}. 
        % Continuing, it has: 
        % \begin{align*}
