...
\section{Introduction}
    ...
    \subsection{Prior works}
        ...
        \par 
        See \todo{$\blacksquare$ Add them \\ $\blacksquare$ Cite them. }{\cite{attouch_first-order_2022}\cite{maulen_speed_2023}} and references within for  the idea of Hessian Damping used to to stabilize the convergence of the Nesterov's momentum without/with restarting. 
