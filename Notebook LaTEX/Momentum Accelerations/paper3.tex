...
\section{Preliminaries}
    Throughout, we define $F := f + g$ where $f: \RR^n \rightarrow \RR$ is $L$ Lipschitz smooth and $\mu \ge 0$ strongly convex and $g: \RR^n \rightarrow \overline \RR$ is proper, closed and convex. 
    We consider optimization problem: $\min_x \left\lbrace f(x) + g(x)\right\rbrace$ where the minimizer exists.
