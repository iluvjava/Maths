...
\section{Formulation of R-WAPG and its convergence rates}
    ...
    \end{proposition}
    \begin{proof}  
        Recall the stepwise convergence theorem, since the choice of $\gamma, \hat \gamma$ is arbitrary choices for the theorem, we choose $\gamma = \rho_{k - 1} L \alpha_{k - 1}^2, \hat \gamma = L \alpha_k^2$ at each step, giving us: 
        {\small
        \begin{align*}
