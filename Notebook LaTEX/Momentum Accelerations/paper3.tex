...
\section{Stepwise formulation of weak accelerated proximal gradient}
    ...
    \begin{remark}
        \textcolor{red}
        {
        Use $\mu = 2D_f(x^*, y_k)/\Vert y_k - x^*\Vert^2$ also works on (4*), $\mu$ is a pessimistic choice for the inequality above. 
        }
...
\section{Formulation of R-WAPG and its convergence rates}
    ...
    \begin{remark}        
        \textcolor{red}
        {
            The choice of $\rho_k$ allows for untraditional choices of step sizes in the literatures. 
...
\section{Equivalent representations of R-WAPG}
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            \right).
        \end{align*}
        Going between the first and second inequality we used $v_k = (1 + \tau_k)y_k - \tau_k x_k$ which is an rearranged $y_k = (1 + \tau_k)^{-1}(v_k + \tau_k x_k)$. 
