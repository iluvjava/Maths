...
\section{Introduction and background}
    \subsection{Motivations}
        ...
        \begin{frame}{Other choices for the momentum sequence part I}
            ...
            \begin{block}{Beck, Teboulle 2009 {\cite[Theorem 4.4]{beck_fast_2009-1}}}
                Commonly known by the name FISTA, it allows $(t_k)_{k \ge 0}$: 
                \begin{align*}
        ...
        \begin{frame}{Other choices for the momentum sequence part III}
            ...
            \begin{block}{Apidopoulos et al. 2018 \cite{apidopoulos_convergence_2020}}
    ...
    \subsection{Our discoveries and inspirations}
        \begin{frame}{Relaxed Weak Accelerated Proximal Gradient}
            ...
            \begin{tcolorbox}
                How much can we relax the choice of the sequence $(t_k)_{k \ge 0}, (\theta_k)_{k \ge 0}$ and retain an upper bound for the convergence rate? 
            \end{tcolorbox}
            ...
            \begin{enumerate}
                ...
                \item It relaxes the assumption of the momentum sequence parameter while retaining an upper bound on the optimality gap. 
            \end{enumerate}
        \end{frame}
        ...
        \begin{frame}{The numerical experiment that had been inspired}
            ...
            \begin{tcolorbox}
                ...
                This information is then used to determine the sequence $(\alpha_k)_{k \ge 0}$ while the algorithm is running. 
            \end{tcolorbox}
            This will come at the last section. 
            The quoted "Bregman Divergence" will be explained in a future slide. 
        \end{frame}
...
\section{The R-WAPG framework and convergence rate}
    \subsection{Introducing the R-WAPG framework}
        \begin{frame}{Proximal gradient, gradient mapping}
            Starting in this section, we will highlight key theoretical results that unify the convergence rate for Euclidean variants of FISTA in the literature.
            \par
        ...
        \end{frame}
        \begin{frame}{The Bregman Divergence}
            We will now explain the "Bregman Divergence" that will be used in our numerical experiment in a later section. 
            \begin{definition}[Bregman Divergence]
                Let $f: \RR^n \rightarrow \RR$ be a differentiable function. 
                We define the Bregman divergence to be: 
                \begin{align}
            ...
            \end{definition}
            \begin{remark}
                Here, $f$ is not necessarily Legendre \cite[Definition 1]{bauschke_descent_2017}, as in the Legendre Transformation of convex analysis. 
            \end{remark}
        \end{frame}
...
\section{Adaptive momentum sequence and numerical experiments}
    ...
    \subsection{Numerical experiment, simple quadratic}
        \begin{frame}{A basic experiment on convex quadratic functions}
            ...
            \begin{enumerate}
                ...
                \begin{align*}
                    ...
                    \end{cases}
                \end{align*}
                \item $L = 1, \mu = 10^{-5}$ are known in prior. Feed $L, \mu$ to V-FISTA and, $L$ to Free R-WAPG. 
        ...
        \begin{frame}{Experiment results 1}
            A realization of $x_0 \sim \mathcal N(I, \mathbf 0)$ is used for V-FISTA, FISTA and Free R-WAPG. 
            ...
            \begin{figure}[H]
                ...
                \end{subfigure}
                \caption{
                    Statistics for experiments with simple convex quadratic for V-FISTA, FISTA, and R-WAPG.
                }
    ...
    \subsection{Numerical experiment, LASSO}
        \begin{frame}{The LASSO problem}
            ...
            \begin{enumerate}
                ...
                \item Let $F_{\min}$ be the smallest value of $F(x_k)$, for all algorithms, over all trials, we estimate $F^+$ by $F^+ = (1 - 2^{53})F_{\min}$. 
            \end{enumerate}
        \end{frame}
        \begin{frame}{Convergence}
            With $A\in \RR^{N\times N}$ fixed, for each $x_0 \sim \mathcal N(\mathbf 0, I)$ realized, 20 experiments are preformed and the medium, minimum and maximum of $\delta_k$ are recorded for FISTA, Free R-WAPG, and V-FISTA. 
            \begin{figure}[H]
                \begin{subfigure}[b]{0.47\textwidth}
                    \centering
