...
\section{The method of Free R-WAPG}\label{sec:free-rwapg}
    ...
    \subsection{Numerical experiments}
        ...
        \subsubsection{Simple convex quadratic}
            ...
            \par
            The numerical experiment shows that FR-WAPG initially behaves similar to M-FISTA, but as the iteration goes on, it started to behave like V-FISTA. 
            ...
            It shows that, the values oscillate and converges to the true $\mu$ value. 
            \begin{figure}[H]
                \centering
                \begin{subfigure}[b]{0.47\textwidth}
                    \centering
