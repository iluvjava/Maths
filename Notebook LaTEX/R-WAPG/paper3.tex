...
\section{Stepwise formulation of weak accelerated proximal gradient}\label{sec:stepwise-stuff}
    ...
    \end{observation}
        ...
        The last equality comes by multiplying both the numerator and denominator by $\hat \gamma_{k + 1}$, then simplifies the numerator by rearranging \eqref{eqn:stepwise-wapg-eqn1} into $\hat \gamma_{k + 1} + \alpha_k \gamma_k = \gamma_k + \alpha_k \mu$. 
    ...
    \begin{proposition}[Stepwise Lyapunov]\label{prop:stepwise-lyapunov}\;\\
        ...
        Given any $v_k, x_k$ and $\gamma_k > 0$ and $v_{k + 1}, x_{k + 1}, y_k, \hat \gamma_{k + 1}$ that satisfies Definition \ref{def:stepwise-wapg}. 
        Define: 
        \begin{align}
            R_{k + 1}
            \defeq
    ...
    \begin{proof}
        ...
        In the proof that follows, we show (\ref{eqn:stepwise-lya-proof-eqn2}) equals to (2.2*). 
        We added (\ref{eqn:stepwise-lya-proof-eqn2}), (\ref{expr:stepwise-lya-expr2.2}) to produce (3*). 
        ...
        \end{align*}
        Then, it can simplifies the following:  
        \begin{align}
        \begin{split}
            &  
        ...
        \end{align*}
        We have \eqref{eqn:stepwise-lya-eqn3.1} = \eqref{eqn:stepwise-lya-proof-eqn1} + \eqref{expr:stepwise-lya-expr2.2}. 
        By \eqref{eqn:stepwise-lya-proof-eqn2} = \eqref{expr:stepwise-lya-expr2.2}, \eqref{eqn:stepwise-lya-proof-eqn1} + \eqref{eqn:stepwise-lya-proof-eqn2} says: 
        \begin{align*}
            & F(x_{k + 1}) + R_{k + 1} + 
            \frac{\hat \gamma}{2}\Vert v_{k + 1} - x^*\Vert^2
            \\
