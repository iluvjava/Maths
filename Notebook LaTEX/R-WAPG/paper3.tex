...
\section{Introduction}
    ...
    \subsection{Contributions of this paper}
        ...
        \par
        Our practical contribution is an algorithm inspired by a detail in the proof of Proposition \ref{prop:wagp-convergence} which is called ``Parameter Free R-WAPG'' (See Algorithm \ref{alg:free-rwapg}). 
...
\section{Stepwise formulation of weak accelerated proximal gradient}\label{sec:stepwise-stuff}
    ...
    \begin{proof}
        ...
        \par
        Proceeding stepwise, we show the following intermediate results: 
