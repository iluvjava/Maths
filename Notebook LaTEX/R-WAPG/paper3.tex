...
\section{The method of Free R-WAPG}\label{sec:free-rwapg}
    ...
    \subsection{Numerical experiments}
        ...
        \subsubsection{Discussion}
            We do not claim a strictly better performance of FR-WAPG (Algorithm \ref{alg:free-rwapg}) compared to well-established variants of APGs in the literatures. 
            Our numericaly experiments are explorative. 
            Nontheless, two things are clear. FR-WAPG performs better than V-FISTA on the first hundreds of iterations and it doesn't require prior knowledge on parameter $L, \mu$. 
            \par
            From a theoretical perspective, the results of R-WAPG is relevent to some degree because the sequence $(\alpha_k)_{k \ge 0}$ generated by Algorithm \ref{alg:free-rwapg} is an R-WAPG sequence. 
            ...
            \par 
            From a practical point of view, the numerical experiments shows that at the start, the estimate for $\mu$ can be very lose.
            This is partially explained by the remark of of Proposition \ref{prop:stepwise-lyapunov}. 
            It also showed that the function value gives very similar charactercteristics of M-FISTA. 
            This hinted at the fact that the sequence $(\alpha_k)_{k \ge 0}$ may has something to do with restarting.
            \par
            Finally, we note that in practice, we observed that the convergence of gradient mapping $\mathcal G_L(y_k)$ becomes more difficult and the algorithm may not be able to terminate for certain objectives. 
