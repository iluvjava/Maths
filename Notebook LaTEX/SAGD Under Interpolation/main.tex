...
\section{Stochastic/Inexact accelerated proximal gradient algorithm}
    ...
    \end{remark}
    The following lemma defines the conditions required for the a momentum sequence to be compatible with convergence claims. 
    % ------------------------------------------------------------------------------------------------------------------
    ...
    \subsection{Building up the convergence results}
        ...
        \begin{proof}
            ...
            \textcolor{red}{Explanations for \circled{1}, \circled{2}, \circled{3} are not done yet}. 
            \par
