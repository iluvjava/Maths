...
\section{In preparations}
    ...
    \subsection{Properties of functions, characterizations}
        ...
        \end{remark}
        % --------------------------------------------------------------------------------------------------------------
        \begin{definition}[semi relative smoothness and Semi-SCNVX \textcolor{red}{NEW}]\label{def:seminorm-smooth-scnvx}
    ...
    \subsection{Important inequalities}
            ...
            \begin{assumption}[affine S-CNVX composition plus non-smooth]\label{ass:snorm-smth-p-nsmth}
...
\section{Stochastic accelerated proximal gradient}
    ...
    % --------------------------------------------------------------------------------------------------------------
    \begin{lemma}[properties of the iterates \textcolor{red}{NEW}]\label{lemma:snapg2-itrs-props}
    ...
    \end{proof}
    % --------------------------------------------------------------------------------------------------------------
    \begin{lemma}[SNAPG-V2 one step convergence prototype stage-I]\label{lemma:snagp2-one-step-s1-proto}
