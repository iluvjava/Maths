...
\section{Lin 2015}
    ...
    \begin{enumerate}
        ...
        \item Controlling the errors of inexact proximal point evaluations is context specific. Lin hinted at ways to track the errors from inexact proximal point evaluations such as using duality and non-negativity assumption of the objective. He illustrated the use of the meta acceleration on their own method called: ``Proximal MISO", in general there is not a universal solution. 
    ...
    \end{definition}
    \begin{remark}
        the algorithm very similarity to
