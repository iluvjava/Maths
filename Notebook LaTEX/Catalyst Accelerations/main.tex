...
\section{Introduction}
    ...
    Gradient descent has an upper bound of $\mathcal O(1/k)$ in iteration complexity of function value that is slower than
    the lower iteration complexity $\mathcal O(1/k^2)$. 
    Accelerated gradient descent has an upper bound of $\mathcal O(1/k^2)$ in function value, making it optimal. 
    \par
...
\section{Theorems and claims for accelerated proximal gradient}\label{app:sec:thm-claim-acc-prox-grad}
    ...
    \begin{theorem}[Canonical form of proximal gradient estimating sequence]\label{thm:canon-prox-grad-est-seq}
        \; \\
        Fix any $x_0 \in \RR^n$. 
