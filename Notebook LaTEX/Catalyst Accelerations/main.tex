...
\section{Non-convex extension of Catalyst acceleration}\label{sec:4wd-catalyst}
    ...
    \begin{theorem}[Basic 4WD Catalyst Convergence]\label{thm:basic-4wd-catalyst}
        ...
        If $F$ is $\kappa$ weakly convex and bounded below, then $x_k$ converges to stationarity where
        \begin{align*}
    ...
    \end{theorem}
    \begin{remark}
        Convergence to stationarity is strictly weaker than convergence to any stationarity point of $F$. 
        Read 
