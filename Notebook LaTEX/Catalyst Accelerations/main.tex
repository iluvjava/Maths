...
\begin{abstract} 
    \noindent
    Nesterov's accelerated gradient appeared sparked numerous theoretical and practical advancements in Mathematics programming literatures since its conception back in 1983. 
    ...
    In this paper we survey the Catalyst Acceleration method which is an modern practical realization of the Accelerated Proximal Point Method proposed by Guler back in 1993. 
...
\bibliography{references/590refs.bib}
\newpage
