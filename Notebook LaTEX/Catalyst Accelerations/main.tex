...
\section{Non-convex Extension of Catalyst Acceleration}
    ...
    The new algorithm handles function with unknown weak convexity constant $\rho$ using the process called Auto Adapt subroutine. 
    For the weakly convex case, only theoretical convergence to stationary point is claimed. 
    \par 
