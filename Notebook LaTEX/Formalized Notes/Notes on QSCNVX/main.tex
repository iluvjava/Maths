...
\section{Our crazy original ideas of extending their definitions}
    ...
    % ------------------------------------------------------------------------------------------------------------------
    \begin{lemma}[conditions when DSBD behaves like norm squared]
    ...
    \subsection{examples for relatively quasi strongly convex functions}
        ...
        \begin{assumption}[distance of two sets]
            ...
            \end{enumerate}
        \end{assumption}
        \begin{theorem}[example of restricted QUA]\label{thm:example-rqua}
