    ...
    \section{Necoara's et al's Paper}
        ...
        \subsection{Weaker conditions of strong convexity}
            ...
            \begin{proof}
                ...
                Using \eqref{ineq:proj-grad} with $z = x^+_\Pi$ it yields: 
                {\small
                \begin{align*}
                    0 &\ge 
        ...
        \subsection{Application, KKT of linear programming}
            ...
            Furthermore, the diference of the function value between 2 points $v, u$ admits an interesting relation via the Bregman Divergence. 
            Observe that $\forall u, v \in \RR^n$ it has 
            \begin{align*}
                f(u) - f(v) &= \langle \nabla f(v), u - v \rangle + D_f(u, v)
                \\
                &= \langle \nabla f(v), u - v \rangle + \langle \nabla f(u) - \nabla f(v), u - v\rangle
                \\
                &= \langle \nabla f(u), u - v\rangle. 
            \end{align*}
...
\chapter{Advanced Enhancement Techniques in Accelerated Proximal Gradient}
    ...
    \section{FISTA made simple}
        ...
        % ==============================================================================================================
        % EXAMPLE | MFISTA WITH ARMIJO LINE SEARCH
        % ==============================================================================================================
        \begin{example}[MFISTA with Armijo line search]\;\\\vspace{-1em}
            \begin{algorithm}[H]
                \begin{algorithmic}[1]
                    \STATE{\textbf{Input:} $x_0 \in \RR^n, L_0 \in \RR^n, f:\RR^n \rightarrow \RR, g: \mathbb \RR^n \rightarrow \overline \RR$} 
                    \STATE{
                        $y_0 := x_0, t_0 := 1$.
                    }
                    \FOR{$k = 0, 1, 2, \ldots$}
            ...
            \end{algorithm}
            We now demonstrate that it's a special case of Definition \ref{def:generic-mapg-ls}.
        ...
        % ==============================================================================================================
        % EXAMPLE | MFISTA WITH CAMBOLLE'S ADAPTIVE BACKTRACKING
        % ==============================================================================================================
        The following example illustrate Chambolle's adaptive backtracking strategy in the literatures with our GMAPG LS. 
        \begin{example}[MFISTA with Chambolle's adaptive backtracking]\;\\\vspace{-1em}
    ...
    \section{Practical enhencements}
