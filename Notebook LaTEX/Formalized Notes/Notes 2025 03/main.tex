...
\chapter{Advanced Enhancement Techniques in Accelerated Proximal Gradient}
    ...
    \section{Practical enhancement from the Nesterov's Monotone Variant}
        ...
        \end{remark}
        \par
        A stronger results on the convergence rate of $\Vert \mathcal G_{1/\eta_k}(y_k)\Vert$ can be obtained if, we assume that the function $F=f + g$ satisfies \ref{ass:standard-fista}. 
