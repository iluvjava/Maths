        ...
        \subsection{Weaker conditions of strong convexity}
            ...
            \begin{proof}
                ...
                \begin{enumerate}
                    ...
                    \item The quadratic growth condition with $\mathbb F(L_f, \kappa_f)$. No convexity is needed. 
                \end{enumerate}
                \textbf{Firstly, we show that QFG implies PEB.}
                Consider \eqref{ineq:proj-grad} with $z = x^+_\Pi$ it yields: 
                {\small
                \begin{align*}
                    0 &\ge 
