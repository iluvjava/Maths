...
\chapter{Advanced Enhancement Techniques in Accelerated Proximal Gradient}
    ...
    \section{FISTA made simple}
        ...
        \begin{theorem}[generic GMAPG LS gradient mapping convergence]\;\label{thm:gmapg-generic-gradmap-convergence}\\
            ...
            If in addition, the sequence $(\alpha_k)_{k \ge 0}$ has $\alpha_0 = 1$ and it is initialized with $x_0=x_0 = T_{1/L_0, f, g}x_{-1}$ for some $x_{-1} \in\RR^n$ and there exists $x^+$ which is a minimizer of $F$. 
        ...
        \end{theorem}
        \begin{proof}
            The following intermediate results are in order for the proof. 
            \begin{enumerate}
                \item[(a)]
            \end{enumerate}
        \end{proof}
    \section{Algorithmic description of GMAPG}
        ...
        This section introduces two variants of line search method used to enhance the accelerated proximal gradient methods in the literatures to demonstrate Definition \ref{def:generic-mapg-ls}. 
        \begin{algorithm}[H]
