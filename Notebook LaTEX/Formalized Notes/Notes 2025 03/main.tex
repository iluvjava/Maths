...
\chapter{Advanced Enhancement Techniques in Accelerated Proximal Gradient}
    ...
    \section{Algorithms formulations of GMAPG}
        ...
        \begin{algorithm}[H]
            ...
            \end{algorithmic}
        \end{algorithm}
        We will now give an algorithimic description of GMAPG. 
        \begin{algorithm}[H]\label{alg:chambolle-btls}
            \begin{algorithmic}[1]
                \STATE{\noindent
                    \textbf{Input:}
                    $f, g, x, v, L> L_{\min} > 0, \rho, \alpha$
                }
        ...
        \begin{algorithm}[H]\label{alg:mfista-chambolle-ada}
            \begin{algorithmic}[1]
                \STATE{\noindent
                    \textbf{Input:} $f, g, x_{-1}, L_0, r_{\min}, \text{Exit condition: }\mathbb E_\chi$. 
                }
