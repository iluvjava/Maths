...
\chapter{Linear Convergence of First Order Method}
    ...
    \section{Necoara's et al's Paper}
        ...
        \subsection{Major Results in the paper}
            ...
            \end{remark}
            Before we start, we will specialize Theorem \ref{theorem:pg-ineq} in our context because it will be used in later proofs. 
            In Assumption \ref{ass:necoara-2019-settings}, it can be seemed as $F = f + g$ in Assumption \ref{ass:smooth-add-nonsmooth} with $g = \delta_{X}$. 
            In this case $\mu_g = 0$ and assuming $f$ is convex we have only $\mu_f = 0$. 
            Therefore the theorem specializes into the following inequality. 
