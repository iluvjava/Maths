...
\chapter{Linear Convergence of First Order Method}
    ...
    \section{Necoara's et al's Paper}
        ...
        \subsection{Application, KKT of linear programming}
            ...
            \begin{align}\label{eqn:lp-cannon-form}
            ...
            \end{align*}
            It's not hard to identify that problem in \eqref{eqn:lp-cannon-form} has representations 
            \begin{align*}
            ...
            \begin{align*}
                ...
                \end{bmatrix}. 
            \end{align*}
            The KKT conditions is a convex feasibility problem which can be formulated by best approxmation problem: 
            \begin{align}\label{eqn:lp-kkt-min}
                \min_{v \in \mathbf K} 
                \frac{1}{2}\Vert Ax - d \Vert^2. 
            \end{align}
            Which is minimizing a quadratic problem on a simple cone. 
            Solving \eqref{eqn:lp-cannon-form} can be approached by optimizing \eqref{eqn:lp-kkt-min}. 
            ...
            The matrix is a block matrix and possibly spase in practice. 
            ...
            \begin{enumerate}
                ...
                \item inner involving of $x_1, x_2$ and $y$. 
            \end{enumerate}
            
            Let $\bar v = (\bar y, \bar x_1, \bar x_2, \xi) \in \RR^m\times \RR^{n_1} \times \RR^{n_2}\times \RR$ then the right mulplication of has: 
            \begin{align*}
                \bar v^TA  &= (
            ...
            \end{align*}
            \begin{enumerate}
                \item Two multplications of the matrix $E$: $\bar y$ on the left and for $\bar x$ on the right, 
            ...
            \begin{align*}
                ...
                \end{bmatrix}. 
            \end{align*}
            In practice, implicitly repressenting the process of $A^TAv$ is better in computing software. 
