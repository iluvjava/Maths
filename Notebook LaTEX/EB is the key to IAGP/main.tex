...
\section{The inexact accelerated proximal gradient with controlled errors}
    ...
    \subsection{The gradient mapping also shrinks}
        ...
        This property will be crucial for analyzing the total complexity for the algorithm as a whole. 
        ...
        \begin{proposition}[sufficient conditions of linear convergence of the inner loop]\;\label{prop:inn-loop-lin-cnvg}\\
            ...
            \begin{enumerate}[nosep]
                ...
                $$
                    ...
                    \right). 
                $$
                \item\label{prop:inn-loop-lin-cnvg:item4} If $\mathbf G_\lambda(z_j, v_j) \le \epsilon$, then $z_j \approx_\epsilon \hprox_{\lambda g}(y)$. 
            \end{enumerate}
        \end{proposition}
        \begin{proof}
