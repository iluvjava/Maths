...
\chapter{The Basics of Optimization Theories}
    ...
    \section{Convexity results}
        ...
        \begin{proof}
            ...
            \end{align*}
        \end{proof}
        \begin{definition}[strong convexity]\label{def:scnvx}
            Let $\alpha \ge 0$. 
            $f: \RR^n \rightarrow \RR^n$ is $\alpha$ strongly convex if and only if $f - \alpha/2\Vert \cdot\Vert^2$ is a convex function. 
        \end{definition}
        \begin{remark}
            The definition doesn't exclude convex functions. 
        \end{remark}
        \begin{theorem}[strong convexity equivalences]\label{thm:scnvx-eqvs}
            Let $f:\RR^n \rightarrow \RR$ be $\alpha \ge 0$ strongly convex then, it is equivalent to 
            \begin{align*}
...
\chapter{Linear Convergence of First Order Method}
    ...
    \section{Necoara's et al.'s Paper}
        \subsection{The Settings}
            ...
            % STRONG CONVEXITY
            % ==================================================================
            \begin{theorem}[strong convexity characterized via Bregman Divergence]\label{thm:breg-div-scnvx}
            ...
            \begin{definition}[relaxations of strong convexity]\;\\
                ...
                \begin{enumerate}
                    ...
                    \item\label{def:necoara-qgg} Quadratic Gradient Growth (QGG): $0\le D_f(x, \bar x) + D_f(\bar x, x) - \kappa_f\Vert x - \bar x\Vert^2$. 
        ...
        \subsection{Weaker conditions of strong convexity}
            ...
            \begin{theorem}[Hierarchy of weaker SCNVX conditions]\label{thm:wcnvx-hierach}
        ...
        \subsection{Characterizing Q-SCNVX functions with Hoffman's error bound}
            ...
            \begin{theorem}[Polyhedral Hoffman Error bound]
            ...
            The following theorem stated their use of the error bound to capture a class of Q-SCNVX function. 
            \begin{theorem}[Q-SCNVX and Hoffman's error bound]\label{thm:q-scnvx-hffmn-eb}
        ...
        \subsection{Feasible descent and accelerated feasible descent}
            ...
            \begin{proof}
                ...
                \begin{enumerate}
                    ...
                    \item $f \in \mathbb S'$ which is the hypothesis that $f$ is Q-SCNVX. 
                    \item $\alpha_k \le L_f^{-1}$, the step size is sufficient to apply descent lemma globally. 
...
\chapter{Going deeper into the literatures}
    This chapter follows the previous chapter but delve deeper into the specifics of the literatures. 
    Most of the thing written here are my own thoughts and inspirations instead of translated ideas from the existing literatures. 
    \section{Quasi strong convexity is a wasteful definition}
...
\chapter{Application, Linear Feasibility Problems}
    ...
    \begin{definition}[a linear conic feasibility problem]\label{def:lcf-problem}
        ...
        \end{align*}
    \end{definition}
    Next, we will give some examples of mathematical programming models that fit the above problem type. 
    \begin{definition}[semidefinite programming]\label{def:SPD}

    \end{definition}
    \begin{definition}[linear feasibility problen]\label{def:LSP}
...
\chapter{Advanced Enhancement Techniques in Accelerated Proximal Gradient}
    ...
    \section{Algorithmic description of \XXAPG{}}
        ...
        \subsection{Monotone routines}
            ...
            $\eta$ is a step size parameter for weakly convex objective $F = f + g$ satisfying Assumption \ref{ass:sum-of-wcnvx}. 
    ...
    \section{Restarting with function values for linear convergence}
        ...
        Both $(n_j)_{j\ge0}, (p_j)_{j\ge 0}$ are non-decreasing sequences. 
        \par
