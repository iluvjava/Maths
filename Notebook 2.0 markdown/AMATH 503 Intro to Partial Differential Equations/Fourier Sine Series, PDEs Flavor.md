...
[Fourier Transform](../AMATH%20582%20Data%20Science/Fourier%20Transform.md), [Fourier Transform Fourier Series](../AMATH%20581%20Scientific%20Computing/Fourier%20Transform%20Fourier%20Series.md)

And we are using the Fourier Series for [Separation of Variables](Separation%20of%20Variables.md)
...
**[Dirichlet Theorem](Dirichlet%20Theorem.md)**
...
But, when we have the graph, something interesting is happening, using the [Dirichlet Theorem](Dirichlet%20Theorem.md), and the fact that the function is odd, we have the positive part of $\cos$ on the interval $[0, \pi]$ reflected by the origin on the interval $[-\pi, 0]$. 
