...
We can still do that on the singularity, but that means we are going to use the [Frobenius Method](Frobenius%20Method.md), which could be a pain to deal with because of the extra multiplier at the front. 
...
[^3]: [Sturm Liouville Theory](Sturm%20Liouville%20Theory.md)