[Fourier Transform, PDE Flavor](Fourier%20Transform,%20PDE%20Flavor.md)
...
Taking the Fourier Transform of a exponential to $x^2$ is related to the [The Drunken Sailor Problem, PDE Problem](The%20Drunken%20Sailor%20Problem,%20PDE%20Problem.md). And it's applied there. 
...
![fourier-contour-integral-gaussian](../Assets/fourier-contour-integral-gaussian.png)
...
1. [1D Wave in Infinite Domain](1D%20Wave%20in%20Infinite%20Domain.md)
2. [The Drunken Sailor Problem, PDE Problem](The%20Drunken%20Sailor%20Problem,%20PDE%20Problem.md)
