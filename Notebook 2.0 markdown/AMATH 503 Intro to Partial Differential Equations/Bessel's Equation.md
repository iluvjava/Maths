This is use for solving the cylindrical wave equation, which is [Helmholtz Equation in a Cylinder](Helmholtz%20Equation%20in%20a%20Cylinder.md), And because we introduce the method of [Frobenius Method](Frobenius%20Method.md) along the way as we go, here I listed some relevant discussion for frobenius method too. 
...
The usage of Frobenius method it's a topic on its own, see [Frobenius Method](Frobenius%20Method.md) for more. 
...
Let's assume that, we are including both the solutions for the General solution for solving [Helmholtz Equation in a Cylinder](Helmholtz%20Equation%20in%20a%20Cylinder.md). 
...
For a more general context of what is discussed here, see [Frobenius Method](Frobenius%20Method.md). 
...
The zeros of the [Helmholtz Equation in a Cylinder](Helmholtz%20Equation%20in%20a%20Cylinder.md). Where we used the notation that $z_{m,n}$ denotes $n$ th zeros of $J_m(x)$. 
