...
This is just a wave equation. And we are going to solve using the D'Alembert method. The details for deriving the D'Alambert method is in [1D Wave in Infinite Domain](1D%20Wave%20in%20Infinite%20Domain.md). Here we are skipping it and jumps straight to the solution of the wave equation.[^2]
