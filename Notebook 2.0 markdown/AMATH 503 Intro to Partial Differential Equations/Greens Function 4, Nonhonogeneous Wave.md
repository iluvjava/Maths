Here we will continue from [Greens Function 3, 3D Wave](Greens%20Function%203,%203D%20Wave.md), with the wave equation as the example, but this case, we make the boundary conditions non-homogeneous too. 
