[Vector Space](Vector%20Space.md), [Metric Space Introduction](Metric%20Space%20Introduction.md), [Norm, for Beginners](../../AMATH%20584%20Numerical%20Linear%20Algebra/Matrix%20Theory/Norm,%20for%20Beginners.md)
...
> These are incomplete normed vector spaces. For examples: $(\Q, |\cdot|), (C[0, 1], \Vert \cdot\Vert_1), (C[0, 1], \Vert \cdot\Vert_2)$. They are incomplete vector spaces. For more details see [Examples of Incomplete, Complete Metrics Space](Examples%20of%20Incomplete,%20Complete%20Metrics%20Space.md). They have completions for their spaces as $\R, L^1[0, 1], L^{2}[0, 1]$. 
