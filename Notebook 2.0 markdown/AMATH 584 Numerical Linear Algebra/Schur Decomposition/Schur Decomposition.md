...
When a matrix is normal, (Recall from [Normal Matrix](../Matrix%20Theory/Normal%20Matrix.md) on what it is.), the Shur's Decomposition of the matrix is the same as the [SVD](../Matrix%20Theory/Matrix%20Decomposition/SVD.md). 
