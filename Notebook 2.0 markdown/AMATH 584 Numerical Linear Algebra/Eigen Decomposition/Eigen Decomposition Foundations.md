...
[Generalized Eigenspaces](../Matrix%20Theory/Generalized%20Eigenspaces.md)
...
Here we are going to sate the results, for the proof for it, consult: [Schur Decomposition](../Schur%20Decomposition/Schur%20Decomposition.md) for more information.
