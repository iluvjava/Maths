...
[Inverse Power Iteration](Inverse%20Power%20Iteration.md)
...
To speed up the algorithm using the idea of inverse iterations, it's discussed here: [Eigen Decomp Algo 3, Shifted QR](Eigen%20Decomp%20Algo%203,%20Shifted%20QR.md). 