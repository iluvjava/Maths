...
Another attempt at covering the concepts of an projector is covered in [Deeper Look into Projector](.md). It's more detailed and have more proofs than what is provided here. 
...
* [HS Reflector](../QR%20Decomposition/HS%20Reflector.md) (The Householder Reflector), it's also an Hermitian Matrix. 
...
![Oblique_projection](../../Assets/Oblique_projection.svg)
...
[Bi-Lanczos](../../MATH%20700%20Master%20Thesis/Bi-Lanczos.md) Algortihm is an algorithm that produces the Bi-orthogonal Subspaces of some matrix operator. 