...
Observe that, the normal cone of a cone is just the polar of that cone. see [Polar Cone](Polar%20Cone.md) for more information.
...
* Normal cone addition, see [Normal Cone Addition](../CVX%20Analysis/Normal%20Cone%20Addition.md). 
