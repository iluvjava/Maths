[Dualization Techniques](../AMATH%20515%20Optimization%20Fundamentals/Duality%20Remastered/Dualization%20Techniques.md), finding the Fenchel dual for a given function. [Convex Conjugation Introduction](Duality/Convex%20Conjugation%20Introduction.md), the definition and interpretations for a convex conjugate of a function, and [MinMax MaxMin Lemma](Duality/MinMax%20MaxMin%20Lemma.md). 
