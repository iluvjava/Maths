...
prereq: [Introduction to Convexity](../../AMATH%20515%20Optimization%20Fundamentals/Basic%20Convexity/Introduction%20to%20Convexity.md)
...
observe that the above $\ge$ can be strict by the mean value theorem and that would mean $f(y)$ is a supremum of an affine function over a set of parameters, therefore by [Convexity Preserving Operations for Functions](../CVX%20Geometry/Convexity%20Preserving%20Operations%20for%20Functions.md), taking the supremum over still makes it convex. 
...
Proof: 1 --> 2 Trivial, 2 --> 3, already did in [Optimality Conditions, Jacobian Hessian](../../AMATH%20515%20Optimization%20Fundamentals/Smooth%20Calculus/Optimality%20Conditions,%20Jacobian%20Hessian.md) 
