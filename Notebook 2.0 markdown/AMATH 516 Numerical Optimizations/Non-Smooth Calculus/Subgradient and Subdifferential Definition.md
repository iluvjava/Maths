...
And that is enough to understand what people are saying. Finally, please observe that a subgradient is a type of multivalued function: [Multivalued Functions, Set-valued Mappings](Multivalued%20Functions,%20Set-valued%20Mappings.md)). 
...
For example: $\partial [f(Ax + b, u)](Ax%20+%20b,%20u)), \partial [u](x^+|f(Ax + b, u)](Ax%20+%20b,%20u))$: Taking the derivative of $f$ wrt to $u$ at the point $x^+$. This notation is adopted by me because it's much clearer compare to some of the textbooks out there. 
