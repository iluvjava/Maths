...
* [Subgradient and Subdifferential Definition](../Non-Smooth%20Calculus/Subgradient%20and%20Subdifferential%20Definition.md)
...
For more, actual examples with step by step derivations regarding the convex conjugate of functions, see [Convex Conjugate Examples](Convex%20Conjugate%20Examples.md) for more information. Here we summarize some of the important results from there in a nice table format. 
