...
* Paper [Proximal Algorithms in Stats and ML](../../MATH%20999%20Paper%20Reviews%20and%20Frontier%20Mathematics/References%20Aug%202022/Proximal%20Algorithms%20in%20Stats%20and%20ML.pdf)
...
Method of multiplier updates each of the primal variable individually, in a Gauss Seidel like manner ([Stationary Iterative Methods](../../AMATH%20585%20Numerical%20Analysis%20of%20BVP/Stationary%20Iterative%20Methods.md)), and then at the end it performs a step of dual ascend. Through out the algorithm, the dual is feasible. For the underlying convergence theory, we consider $f, g$ to be lsc, proper and convex, and form the primal problem and the augmented Lagrangian as the following: 
...
It's separate, see [ADMM Convergence](../ADMM%20Convergence.md) for more details. We make the same assumptions as before when we derive the feasibility of the algorithm during the iteration, that $f, g$ are augmented real functions and CCP, at the same time, strong duality holds for the problem so that a saddle point can be identified. 
