prereq: [Lagrange Polynomial Interpolation](../MATH%20464/Lagrange%20Polynomial%20Interpolation.md)
...
**NOTE** This can be extended, the boundary can change according to time, or even in the 2d case, it can change according to the space too, and the key here is to just do the Surgery during each evaluate of the right hand side. The same as the [Direct Method](Direct%20Method.md) using the finite difference. 
