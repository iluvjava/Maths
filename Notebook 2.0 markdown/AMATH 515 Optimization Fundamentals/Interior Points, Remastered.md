...
Previous Version: [Interior Points](Interior%20Points.md),

References
1. [Dualization Examples](Duality%20Remastered/Dualization%20Examples.md), About how we get the Lagrangian
2. [Exploiting the Lagrangian (KKT)](Duality%20Remastered/Exploiting%20the%20Lagrangian%20(KKT).md), Some more information and background about the optimality conditions we are exploiting for Interior Points algorithm. 
...
Firstly, let's pick up from the strong duality: [Dualization Examples](Duality%20Remastered/Dualization%20Examples.md), we conclude the saddle node of the Lagrangian representing the optimality conditions which should give us: 
...
Take note that this is the same as the results we gotten from [Duality (Example Transformation)](Duality/Duality%20(Example%20Transformation).md), and the positive constraint of the dual variable is taken from the indicator function into the Lagrangian. 
