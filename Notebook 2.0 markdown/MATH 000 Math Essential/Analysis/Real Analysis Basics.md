...
Besides that, I will just put whatever I want here. I am only writing this file after I am graduate school, PhD. So it's quite late and I forgot a bunch of the basics Real Analysis that I learned. I am doing this for functional analysis. These 2 things lie too close to each other to be ignored because a lot of these results are generalized into [Metric Space Introduction](../../MATH%20601%20Functional%20Analysis/Functional%20Spaces/Metric%20Space%20Introduction.md), a fundamental element that build up the functional spaces. Another one is vector space which has foundations in linear algebra. 
...
* [Convergence of Cauchy Sequences](Convergence%20of%20Cauchy%20Sequences.md)
...
* [Limit, Cluster Point of a Sequence Set](Limit,%20Cluster%20Point%20of%20a%20Sequence%20Set.md)
* [Closure Topology](../../AMATH%20516%20Numerical%20Optimizations/Background/Closure%20Topology.md), which can be characterized by limit point of the set. 
