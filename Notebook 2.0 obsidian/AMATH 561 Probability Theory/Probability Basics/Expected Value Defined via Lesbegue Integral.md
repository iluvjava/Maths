...
- Here we introduce some fancy integral that can help use figure out the expected value of some random variable, and it's complementary to [[../../STATS 501 Statistics for Mathematicians/Expectations of Random Variables without Measure Theory]]. 
