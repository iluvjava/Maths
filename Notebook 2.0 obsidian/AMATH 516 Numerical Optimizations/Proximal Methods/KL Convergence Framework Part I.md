...
3. **(iv)** requires using [Connected Cluster Points of an Eventual Stationary Sequence](../Background/Connected%20Cluster%20Points%20of%20an%20Eventual%20Stationary%20Sequence.md) and theorem of bounded sequences. 
