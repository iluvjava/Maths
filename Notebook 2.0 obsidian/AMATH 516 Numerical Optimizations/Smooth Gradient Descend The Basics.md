...
Item (3.) 3 measures how close $x$ is a stationary point. 
...
Assume optimal metric (1.) implies (3.), if a minimizer exists then the gradient at the minimizer can be is zero, reaching the optimality. 
The converse is false. 
