...
> Let $(x_k, y_k, v_k)$ to be generated as specified by Algorithm 2.2 by the $(\alpha_k)_{k \ge0}$. Then iterate $(v_k)$ can be expressed without $y_k, v_k$ by: 
> $$
> \begin{aligned}
>     y_k &= 
>     \left(
...
\begin{aligned}
    ...
    \\
    &= 
    L\alpha_{k + 1}(\alpha_{k + 1} + \rho_k \alpha_k^2) - \alpha_{k + 1}\mu - \mu \rho_k \alpha_k
    \\
...
#### **Theorem | The weak Momentum Sequence**
