...
On the above derivation, the first equality is by definition of $v_{k + 1}$; the last equality is by $\gamma_{k + 1} = (1 - \alpha_k)\gamma_k + \mu \alpha_k$ the second equality comes by considering: 
...
---
### **What is this algorithm really?**

Next, I will attempt to reduce it to similar triangle form. 