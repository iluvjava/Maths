...
#### **Sufficient conditions for an missed update in the estimate**
...
The conditions `(1), (2)`, depends on $(x_t, x_{t -1})$, it's a 2 parameters setup, making things complicated. 