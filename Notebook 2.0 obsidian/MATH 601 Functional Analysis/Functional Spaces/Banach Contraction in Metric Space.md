...
That mapping is actually the [Newton's Method 1D](../../MATH%20464/Newton's%20Method%201D.md) for finding the root $x^2 - c=0$. 
...
We had verified that this ancient formula for computing the square is a Banach Contraction. For more goodies about fixed point iterations and their theories, visit [Fixed Point Iterations 1D](../../MATH%20464/Fixed%20Point%20Iterations%201D.md) for more information.
